...
class EventServiceProvider extends ServiceProvider
{
    ...
    {
        $cacheKey = 'domain_manager_events_and_observers';
    ...
    protected function customDiscoverEvents()
    {
        ...
        $namespace = 'Innoboxrr\DomainManager\Http\Events\\';
    ...
    protected function customDiscoverObservers()
    {
        ...
        $namespaceModel = 'Innoboxrr\DomainManager\Models\\';
        $namespaceObserver = 'Innoboxrr\DomainManager\Observers\\';
