...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\DomainManager\Models\DomainPayment,id',
    ...
    public function handle()
    {
         ...
         $domainPayment = ($this->id) ? 
            DomainPayment::findOrFail($this->id) : 
            app(DomainPayment::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $domainPayment),
        ]);
