...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\DomainManager\Models\DomainPaymentMethod,id',
    ...
    public function handle()
    {
         ...
         $domainPaymentMethod = ($this->id) ? 
            DomainPaymentMethod::findOrFail($this->id) : 
            app(DomainPaymentMethod::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $domainPaymentMethod),
        ]);
