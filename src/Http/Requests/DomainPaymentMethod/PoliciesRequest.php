...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\DomainManager\Models\DomainPaymentMethod,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DomainPaymentMethod::findOrFail($this->id) : app(DomainPaymentMethod::class);
