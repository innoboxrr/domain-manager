...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\DomainManager\Models\DomainContact,id',
    ...
    public function handle()
    {
         ...
         $domainContact = ($this->id) ? 
            DomainContact::findOrFail($this->id) : 
            app(DomainContact::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $domainContact),
        ]);
