...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\DomainManager\Models\DomainSubscription,id',
    ...
    public function handle()
    {
         ...
         $domainSubscription = ($this->id) ? 
            DomainSubscription::findOrFail($this->id) : 
            app(DomainSubscription::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $domainSubscription),
        ]);
