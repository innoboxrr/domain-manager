...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\DomainManager\Models\DomainSubscription,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DomainSubscription::findOrFail($this->id) : app(DomainSubscription::class);
