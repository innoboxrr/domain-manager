...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\DomainManager\Models\DomainProviderPayment,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DomainProviderPayment::findOrFail($this->id) : app(DomainProviderPayment::class);
