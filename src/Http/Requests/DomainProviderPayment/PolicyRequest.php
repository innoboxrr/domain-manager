...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\DomainManager\Models\DomainProviderPayment,id',
    ...
    public function handle()
    {
         ...
         $domainProviderPayment = ($this->id) ? 
            DomainProviderPayment::findOrFail($this->id) : 
            app(DomainProviderPayment::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $domainProviderPayment),
        ]);
