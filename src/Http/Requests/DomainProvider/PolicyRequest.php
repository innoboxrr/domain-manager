...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\DomainManager\Models\DomainProvider,id',
    ...
    public function handle()
    {
         ...
         $domainProvider = ($this->id) ? 
            DomainProvider::findOrFail($this->id) : 
            app(DomainProvider::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $domainProvider),
        ]);
