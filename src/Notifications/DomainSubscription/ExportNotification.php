...
namespace Innoboxrr\DomainManager\Notifications\DomainSubscription;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainSubscriptionsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainSubscriptionsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainSubscription export notification';
    }
