...
namespace Innoboxrr\DomainManager\Notifications\DomainPayment;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainPaymentsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainPaymentsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainPayment export notification';
    }
