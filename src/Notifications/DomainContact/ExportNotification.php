...
namespace Innoboxrr\DomainManager\Notifications\DomainContact;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainContactsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainContactsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainContact export notification';
    }
