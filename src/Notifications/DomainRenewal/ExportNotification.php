...
namespace Innoboxrr\DomainManager\Notifications\DomainRenewal;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainRenewalsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainRenewalsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainRenewal export notification';
    }
