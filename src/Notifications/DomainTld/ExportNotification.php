...
namespace Innoboxrr\DomainManager\Notifications\DomainTld;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainTldsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainTldsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainTld export notification';
    }
