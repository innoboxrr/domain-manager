...
namespace Innoboxrr\DomainManager\Notifications\DomainPaymentMethod;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainPaymentMethodsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainPaymentMethodsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainPaymentMethod export notification';
    }
