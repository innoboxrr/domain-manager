...
namespace Innoboxrr\DomainManager\Notifications\DomainProvider;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainProvidersExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainProvidersExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainProvider export notification';
    }
