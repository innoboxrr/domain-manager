...
namespace Innoboxrr\DomainManager\Notifications\DomainDns;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainDnsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DomainDnsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DomainDns export notification';
    }
