...
namespace Innoboxrr\DomainManager\Notifications\Domain;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\DomainManager\Exports\DomainsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        return env('APP_NAME') . ' | Domain export notification';
    }
