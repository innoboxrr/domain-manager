<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="domainPaymentExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-payment/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-payment' 
