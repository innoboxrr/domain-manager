<template>
	...
	<div id="AdminDomainProviderPaymentsWrapper">
...
<script>
	...
	import DataTable from '@domainModels/domain-provider-payment/widgets/DataTable.vue'
	...
	export default {
		...
		computed: {
			...
			isHome() {
				...
				return (this.$route.name == 'AdminDomainProviderPayments');
