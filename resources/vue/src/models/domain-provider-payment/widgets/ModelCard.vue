	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDomainProviderPayment,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDomainProviderPayment() {

	    		deleteModel(this.domainProviderPayment).then( res => {

	    			this.$router.push({ name: 'AdminDomainProviderPayments' });
