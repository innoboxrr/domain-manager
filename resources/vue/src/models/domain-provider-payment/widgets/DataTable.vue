<template>
	...
	<data-table
		title="DomainProviderPayment" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="domainProviderPaymentExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-provider-payment/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-provider-payment' 
	...
	export default {
		...
		computed: {
			...
			domainProviderPaymentExternalFilters() {
