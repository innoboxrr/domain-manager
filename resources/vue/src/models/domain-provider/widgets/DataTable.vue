<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="domainProviderExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-provider/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-provider' 
