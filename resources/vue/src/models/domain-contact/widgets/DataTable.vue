<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="domainContactExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-contact/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-contact' 
