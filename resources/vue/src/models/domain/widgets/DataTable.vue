<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="domainExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain/forms/FilterForm.vue'
	import * as model from '@domainModels/domain' 
