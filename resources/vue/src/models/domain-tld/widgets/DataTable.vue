<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="domainTldExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-tld/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-tld' 
