<template>
	...
	<data-table
		title="DomainSubscription" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="domainSubscriptionExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-subscription/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-subscription' 
	...
	export default {
		...
		computed: {
			...
			domainSubscriptionExternalFilters() {
