<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="domainDnsExternalFilters"
...
<script>
	...
	import FilterForm from '@domainModels/domain-dns/forms/FilterForm.vue'
	import * as model from '@domainModels/domain-dns' 
